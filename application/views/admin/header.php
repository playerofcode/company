...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/');?>plugins/fullcalendar/main.css">
  <!-- iCheck -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="fullscreen" href="<?php echo base_url('admin/logout');?>" role="button">
          <i class="fas fa-sign-out-alt"></i>
        </a>
      </li>
      <!-- <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="<?php echo base_url('admin/logout');?>" role="button">
